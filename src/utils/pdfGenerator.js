...
export const generateUSMCAPDF = (partNumber, partDescription, htsusMain, results) => {
  ...
  //Agregar logo
  doc.addImage(logo,'PNG',10,-7.8,40,40);
  ...
  doc.text(`Part Description: ${partDescription}`, doc.internal.pageSize.width / 2, 14.5, { align: "center" });

  doc.setFontSize(7);
  doc.text(`Date Cost: ${dateStr}                    Reference Currency: USD`, doc.internal.pageSize.width / 2, 17, { align: "center" });
  doc.text(`Qualify: ${results.contentRVC}                    HTS: ${htsusMain}`, doc.internal.pageSize.width / 2, 19.5, { align: "center" });
  ...
  doc.autoTable({
    ...
    columnStyles: {
      0: { halign: "left" },
      1: { halign: "left" },
      2: { halign: "center", fontStyle: "Regular", font: "Roboto" },
      3: { halign: "center" },
      4: { halign: "right" },
      5: { halign: "center" },
      6: { halign: "right" },
